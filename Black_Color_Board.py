        ...
        for i in range(0, self.size):
            ...
            for j in range(0, self.size):
                ...
                if new != state:
                    ...
                    successors[f'x: {i}, y: {j}'] = tuple(new)
...
if __name__ == "__main__":
    ...
    for j in range(0, n):
        a = []
        for i in range(0, n):
            a.append(int(colors[i + j*n]))
        matrix.append(tuple(a))
    ...
    s = Black_Squares(n, tuple(matrix), tuple(goal))
