...
class Explorer(Problem):
    ...
    def successor(self, state):
        ...
        yGrid = self.grid_size[1]
        xGrid = self.grid_size[0]

        if obstacle1[2] == 0:  # up
            if obstacle1[1] == yGrid - 1:
                obstacle1[2] = 1
                obstacle1[1] -= 1
            else:
                obstacle1[1] += 1
        ...
        # Right
        if man_x < xGrid - 1 and [man_x + 1, man_y] not in obstacles:
        ...
        if man_x > 0 and [man_x - 1, man_y] not in obstacles:
            successors['Left'] = (man_x - 1, man_y,
                                  ...
                                  obstacle2[0], obstacle2[1], obstacle2[2])
        # Up
        if man_y < yGrid - 1 and [man_x, man_y + 1] not in obstacles:
